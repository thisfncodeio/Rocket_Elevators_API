class LeadsController < ApplicationController
    ...
    def lead_params
        params.required(:leads).permit(:files, :full_name_of_contact, :company_name, :email, :phone, :project_name, :project_description, :department_in_charge_of_elevators, :message)
    end
